...
{
    public class SquidGO : AlienCategory
    {

        public SquidGO(GameObject.Name name, GameSprite.Name spriteName, float posX, float posY)
        ...
        public override void VisitMissileGroup(MissileGroup m)
        {
            ...
            //check missile vs. "this" Squid object 
