...
namespace SpaceInvaders
{
    class AnimateSquid : Animation
    {
        ...
        public AnimateSquid(Animation.Name animName, GameSprite.Name spriteName) 
            : base(animName)
        {
        ...
        public override void Execute(float deltaTime)
        {
            ...
            TimerMan.Add(TimeEvent.Name.AnimateSquid, this, deltaTime);
        }
    }
}
